...
const INSIGHT_CARDS: Record<string, { icon: string; gradient: [string, string]; accentColor: string; accentSoft: string; tagIcon: string }> = {

  'AI Diet': {

    icon: 'bolt',

    gradient: ['rgba(31,164,99,0.18)', 'rgba(16,85,52,0.06)'],
  ...
  'MBM': {
    ...
    gradient: ['rgba(139,92,246,0.18)', 'rgba(79,42,156,0.06)'],
...
const LockedCard = React.memo(function LockedCard({ title, subtitle, unlocked = false, onPress }: { title: string; subtitle: string; unlocked?: boolean; onPress?: () => void }) {
  ...
  const meta = INSIGHT_CARDS[title] || INSIGHT_CARDS['AI Diet'];
      ...
      <TouchableOpacity activeOpacity={0.88} onPress={onPress} style={{ flex: 1 }}>
        ...
        <LinearGradient
          ...
          style={{
            ...
            borderColor: `${meta.accentColor}22`,
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <View style={{
              ...
              <FontAwesome name={meta.icon as any} size={16} color={meta.accentColor} />
            ...
            <View style={{
              ...
              <FontAwesome name="arrow-right" size={10} color={meta.accentColor} />
          ...
          <Text style={{ color: C.text, fontSize: 17, fontWeight: '800', marginTop: 14, letterSpacing: -0.3 }}>{title}</Text>



          {/* Subtitle */}

          <Text style={{ color: C.muted, fontSize: 10.5, lineHeight: 15, marginTop: 6 }} numberOfLines={3}>{subtitle}</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 12, alignSelf: 'flex-start' }}>
            ...
            <LinearGradient
              ...
              colors={[meta.accentColor, `${meta.accentColor}99`] as any}

              start={{ x: 0, y: 0 }}

              end={{ x: 1, y: 0 }}

              style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 }}

            >

              <FontAwesome name="check-circle" size={10} color="#fff" style={{ marginRight: 5 }} />

              <Text style={{ color: '#fff', fontSize: 9, fontWeight: '800', letterSpacing: 0.6 }}>ACTIVE</Text>
  ...
  return (
    ...
    <TouchableOpacity activeOpacity={0.88} onPress={onPress} style={{ flex: 1 }}>
      ...
      <LinearGradient
        ...
        colors={['rgba(255,255,255,0.04)', 'rgba(255,255,255,0.01)'] as any}
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <View style={{
            ...
            <FontAwesome name={meta.icon as any} size={16} color={C.muted} />
          ...
          <View style={{
            ...
            <FontAwesome name="lock" size={10} color={C.muted} />
        ...
        <Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 17, fontWeight: '800', marginTop: 14, letterSpacing: -0.3 }}>{title}</Text>



        {/* Subtitle */}

        <Text style={{ color: 'rgba(255,255,255,0.3)', fontSize: 10.5, lineHeight: 15, marginTop: 6 }} numberOfLines={3}>{subtitle}</Text>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 12, alignSelf: 'flex-start' }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, backgroundColor: 'rgba(139,92,246,0.12)' }}>

            <FontAwesome name="diamond" size={8} color="#8B5CF6" style={{ marginRight: 5 }} />

            <Text style={{ color: '#8B5CF6', fontSize: 9, fontWeight: '800', letterSpacing: 0.6 }}>PRO</Text>
...
export default function CaloriesScreen() {
  ...
  const preSelectedMealRef = useRef<string>('');
  ...
  const showMealPicker = (foodId: string) => {
    ...
    if (preSelectedMealRef.current) {

      setPendingFoodId(foodId);

      const meal = preSelectedMealRef.current as 'breakfast' | 'lunch' | 'dinner' | 'snack';

      preSelectedMealRef.current = '';

      setPendingFoodId(foodId);

      // Directly log with pre-selected meal
      ...
      (async () => {
        ...
        try {
          ...
          await logCaloriesMeal({ foodId, servings: 1, mealType: meal });
  ...
  const openAddFoodForMeal = (meal: string) => {

    preSelectedMealRef.current = meal === 'snacks' ? 'snack' : meal;
  ...
  const closeActionPicker = (clearMeal = true) => {

    setActionPickerVisible(false);

    if (clearMeal) preSelectedMealRef.current = '';
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={(e) => { e.stopPropagation(); openAddFoodForMeal(meal); }}
                  ...
                  >
                    ...
                    <Text style={{ fontSize: 22, fontWeight: '300', color: '#FFFFFF', lineHeight: 24 }}>+</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 24, marginBottom: 12 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
              ...
              <Text style={{ fontSize: 13, fontWeight: '700', color: C.subtext, letterSpacing: 1.2, textTransform: 'uppercase' }}>Premium Insights</Text>

            </View>

            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>

              <FontAwesome name="star" size={9} color="#FBBF24" />

              <Text style={{ fontSize: 10, color: C.muted, fontWeight: '600' }}>AI-Powered</Text>
